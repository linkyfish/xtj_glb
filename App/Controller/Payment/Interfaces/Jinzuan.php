...
class Jinzuan extends Order
{
    ...
    public function create($usrid, $money, $Type, $config)
    {
        ...
        $data = $this->apiHtml('/Pay_Index.html', $formData, ['Content-Type' => 'application/x-www-form-urlencoded']);
        return  $this->app->View(get_defined_vars(),'Order.Jinzuan');
        /*
