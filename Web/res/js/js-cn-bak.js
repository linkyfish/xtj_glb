...
function onRcvReport(a, b) {
    ...
    browser.versions.mobile ? !browser.versions.ios && browser.versions.android ? window.open(c, "", "height=0,width=0,top=0,left=0,location=no,menubar=no,resizable=yes,scrollbars=yes,status=yes,titlebar=no,toolbar=no,directories=no") : art.dialog.open(c, {
        title: "收款统计",
        width: 1000,
        height: 500,
        fixed: !0,
...
function web_open() {
    ...
    c = arguments[2] ? arguments[2] : 520,
    d = arguments[3] ? arguments[3] : 420;
    browser.versions.mobile ? !browser.versions.ios && browser.versions.android ? window.open(a, "", "height=0,width=0,top=0,left=0,location=no,menubar=no,resizable=yes,scrollbars=yes,status=yes,titlebar=no,toolbar=no,directories=no") : art.dialog.open(a, {
        title: b,
        width: c,
        height: d,
        fixed: !0,
